...
export const LoginForm = ({form, loading, onChange, onSubmit, onSwitchToRegister}: Props) => (
    <form onSubmit={onSubmit} className="flex flex-col gap-4">
        ...
        <div>
            ...
            <Input
                type="password" placeholder="••••••••" required autoComplete="current-password"
        ...
        <p className="text-center text-sm text-gray-500">
            Нет аккаунта?{' '}
            <button type="button" className="text-indigo-600 hover:underline font-medium" onClick={onSwitchToRegister}>
                Зарегистрироваться
            </button>
        </p>
    </form>
